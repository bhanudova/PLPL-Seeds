...
export default function FertilizersChemicalTreatment() {
    return (<>
        <div>

            <div className="relative w-full h-full">
                {/* Banner Image */}
                <Image src={'/images/ChemicalTreatmentExcellence_Banner.jpg'} width={500} height={500} alt="LushHarvest_Banner" className="w-full h-[20rem] md:h-[28rem] object-cover" />
            ...
            <div className="flex justify-center items-center bg-white text-black p-6 md:p-10">
                <div>
                    ...
                    <div className="flex justify-center items-center mt-4 lg:mt-0 p-0 lg:p-10">
            ...
            <div className="bg-purple-800 p-10 text-white">
                ...
                <div className="flex justify-center items-center">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 mt-6 w-full lg:w-[70rem]">
                        <div className="flex gap-2 lg:gap-4">
                            <h2 className="font-bold text-4xl lg:text-5xl text-green-300">1</h2>
                            <div>
                        ...
                        <div className="flex gap-2 lg:gap-4 mt-6 md:mt-0">
                            <h2 className="font-bold text-4xl lg:text-5xl text-green-300">2</h2>
                            <div>
                        ...
                        <div className="flex gap-2 lg:gap-4 mt-6 md:mt-0">
                            <h2 className="font-bold text-4xl lg:text-5xl text-green-300">3</h2>
                            <div>
            ...
            <div className="flex justify-center items-center">
                <div className="flex flex-col lg:flex-row gap-4 mt-10 lg:mt-0 p-10 text-black bg-white">
                        ...
                        <div className="flex justify-center items-center">
                            <div className="grid grid-cols-3 gap-2 md:gap-4">
                                <div className="border-2 ">
                                    <Image src={'/images/precision_fertilizer_application.png'} width={500} height={500} alt="precision_fertilizer_application" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                                <div className="border-2 ">
                                    <Image src={'/images/innovative_fertilizer_formulas.png'} width={500} height={500} alt="innovative_fertilizer_formulas" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                                <div className="border-2 ">
                                    <Image src={'/images/advanced_chemical_treatment.png'} width={500} height={500} alt="advanced_chemical_treatment" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                                <div className="border-2 ">
                                    <Image src={'/images/healthy_crop_results.png'} width={500} height={500} alt="healthy_crop_results" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                                <div className="border-2 ">
                                    <Image src={'/images/precision_fertilizer_delivery.png'} width={500} height={500} alt="precision_fertilizer_delivery" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                                <div className="border-2 ">
                                    <Image src={'/images/modern_agricultural_practices.png'} width={500} height={500} alt="modern_agricultural_practices" className="object-cover w-full h-[8rem] md:w-[14rem] md:h-[10rem]" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mt-4 lg:mt-0">
                        <div className="flex justify-center items-center">
                            <Image src={'/images/sustainable_agriculture.png'} width={500} height={500} alt="demo_chemical_treatment3" className="w-full h-[20rem] md:h-[40rem] lg:h-[60rem] object-cover" />
                        </div>
                    </div>
                </div>
            </div>
