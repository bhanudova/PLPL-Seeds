...
const HomeBoxData = [
    ...
    { id: 5, image: '/images/home_tissue_culture.jpg', position: 'order-first', title: 'Introduction to Prasad group&rsquo;s Tissue Culture', description: 'Introduction to Tissue Culture Prasad groups your one step towards a flourishing agricultural futurePLPL Groups is a leading company in tissue culture, offering advanced plant cell and tissue cultivation in a controlled laboratory setting. Our state-of-the-art facilities and expert team ensure efficient production of genetically identical plants across various species. We collaborate closely with clients to tailor our services to their specific needs, making us the preferred choice for agricultural producers and horticulturists seeking top-tier tissue culture services.Welcome to the fascinating realm of tissue culture.' },
    { id: 6, image: '/images/home_quality.jpg', position: 'order-last', title: 'Quality Management.', description: 'PLPL, a premier outsourcing partner in the agricultural sector, offers comprehensive turnkey solutions to global Agri companies. With a legacy spanning over 30 years, PLPL has consistently delivered infrastructure for processing high-quality products that meet stringent quality standards while ensuring economies of scale. Our core business proficiency includes tailor-made solutions for production, processing, packaging, storage, and distribution, all while utilizing state-of-the-art equipment.' },
